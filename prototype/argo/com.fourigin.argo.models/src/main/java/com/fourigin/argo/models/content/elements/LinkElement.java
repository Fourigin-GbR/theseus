...
public class LinkElement extends AbstractContentElement implements NamedElement, ContentElementsContainer, LinkAwareContentElement {
    ...
    @Override
    public int hashCode() {
        return Objects.hash(super.hashCode(), title, elements, url, anchorName, target);
    }
    ...
    public static class Builder {
        ...
        public LinkElement.Builder withTitle(String language, String title) {
